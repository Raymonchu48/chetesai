        ...
        <div className="mx-auto max-w-[560px]">
          ...
          <div className="mb-7 grid grid-cols-2 rounded-full bg-[#f0f1ed] p-1" role="tablist" aria-label="Tipo de acceso">
            <button
              ...
              onClick={() => {
                setAccessRole("profesional");
                setError("");
              }}
              className={`rounded-full px-4 py-3 text-sm font-black transition-all sm:text-base ${
                accessRole === "profesional"
                  ? "bg-[#98f21f] text-[#07182b] shadow-[0_6px_16px_rgba(142,229,0,0.18)]"
                  : "text-[#657080] hover:text-[#07182b]"
              }`}
            >
              Profesional
            </button>
