    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_right,_rgba(140,219,120,0.13),_transparent_30%),linear-gradient(180deg,#f4f1e9_0%,#faf9f5_52%,#f1eee7_100%)] px-4 py-6 text-[#202724] sm:px-6 sm:py-10">
      <div className="mx-auto max-w-6xl">
        <header className="relative mb-7 overflow-hidden rounded-[30px] border border-[#d7b86b]/30 bg-[#111a15] p-6 text-white shadow-[0_22px_70px_rgba(17,26,21,0.22)] sm:p-8">
          ...
          <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between"><div><p className="text-[11px] font-black uppercase tracking-[0.24em] text-[#d7b86b]">Chetesaí Fitness+</p><h1 className="mt-3 flex items-center gap-3 text-3xl font-black tracking-tight sm:text-4xl"><span className="grid h-12 w-12 place-items-center rounded-2xl bg-[#8cdb78] text-[#101713]"><Dumbbell className="h-7 w-7" /></span>Mi entrenamiento</h1><p className="mt-4 max-w-xl text-sm leading-6 text-white/65">{data?.cliente?.nombre ? `Hola, ${data.cliente.nombre}. Aquí tienes tu planificación activa.` : "Tu espacio privado de entrenamiento."}</p></div>
